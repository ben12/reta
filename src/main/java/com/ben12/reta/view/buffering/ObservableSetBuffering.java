		...
		PropertyValidation
{
	...
	public ObservableSetBuffering(ObservableSet<E> newSubject)
	{
	 ...
	 * 
	 */
	public ObservableSetBuffering(Class<?> newBeanType, String newPropertyName, ObservableSet<E> newSubject)
	{
